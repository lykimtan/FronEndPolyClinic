...
<template>
  <nav class="flex justify-between items-center bg-blue-700 shadow-sm py-3 px-8 sticky top-0 z-10">
    <!-- Logo -->
    <router-link to="/staff/dashboard">
      <div class="flex items-center space-x-3">
        <img src="../../assets/HealthCare.png" alt="HealthMate Logo" class="w-20 h-20" />
        <span class="text-xl font-semibold text-white">HealthMate</span>
      </div>
    </router-link>
    ...
    <div class="hidden md:flex space-x-4">
      <router-link
        to="/staff/recurring-schedule-management"
      ...
      <router-link
        to="/staff/medication-management"
        class="flex items-center bg-white text-sky-500 font-medium rounded-full px-5 py-2 hover:bg-sky-600 hover:text-white transition"
      >
        <button>
